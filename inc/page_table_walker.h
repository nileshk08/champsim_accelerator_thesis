...
class PAGE_TABLE_WALKER : public MEMORY {
  public:
    ...
    uint64_t total_reuse_distance,number_of_reuse_distance;
	...
	number_of_reuse_distance = 0;
	PTW_latency = 0;
	rq_entries = 0;
	pq_entries = 0;
	prefetch_mshr_entries = 0;
	mshr_entries = 0;
	rq_count_cycle = 0;
	prefetch_mshr_count_cycle = 0;
	pq_count_cycle = 0;
	mshr_count_cycle = 0;
	PTW_rq = 0;
    ...
    int add_mshr(PACKET *packet),
	    add_prefetch_mshr(PACKET *packet);
