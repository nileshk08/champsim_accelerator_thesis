...
class O3_CPU {
  public:
    ...
    CACHE ITLB{"ITLB", ITLB_SET, ITLB_WAY, ITLB_SET*ITLB_WAY, ITLB_WQ_SIZE, ITLB_RQ_SIZE, ITLB_PQ_SIZE, ITLB_MSHR_SIZE},
          ...
          SCRATCHPAD{"SCRATCHPAD", SCRATCHPAD_SET, SCRATCHPAD_WAY, SCRATCHPAD_SET * SCRATCHPAD_WAY, SCRATCHPAD_WQ_SIZE, SCRATCHPAD_RQ_SIZE, SCRATCHPAD_PQ_SIZE,SCRATCHPAD_MSHR_SIZE};	//Nilesh: Sratchpad cache
    ...
    // functions
    void handle_branch(),
	 print_LSQ(LOAD_STORE_QUEUE *queue),
	 print_ROB(uint32_t index),
         fetch_instruction(),
